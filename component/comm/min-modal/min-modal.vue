    ...
    export default {
        ...
        data() {
            return {
                ...
                cancelColor: '',
                cancelText: '取消',
                confirmColor: styleConf.color_primary,
                confirmText: '确定',
                actions: [],
                actionMode: true,
                isClick: true,
        ...
        methods: {
            handleShow({
                           title = '操作提示', content = '是否确认当前操作', modalID = 'modal',
                           showCancel = true, cancelColor = '',
                           cancelText = '取消', confirmColor = styleConf.color_primary,
            ...
            handleHide() {
                ...
                this.timer = setTimeout(() => {
                    ...
                    this.cancelColor = ''
                    this.cancelText = '取消'
                    this.confirmColor = styleConf.color_primary
                    this.confirmText = '确定'
                    this.actions = []
